    ...
    <div class="flex justify-center border-t border-black-light">
        <div>
            @component('_components/prevcard')
                @slot('img') http://labor.mxzl.de/data/img/pic/anonym-min.jpg @endslot
            ...
            @endcomponent
            @component('_components/prevcard')
                @slot('img') http://labor.mxzl.de/data/img/pic/idea-min.jpg @endslot
            ...
            @endcomponent
            @component('_components/prevcard')
                @slot('img') http://labor.mxzl.de/data/img/pic/notes-min.jpg @endslot
