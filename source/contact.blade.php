...
@section('body')
    ...
    <form class="w-full max-w-xs" name="contact" netlify>
        ...
        <div class="md:flex md:items-center mb-6">
            ...
            <div class="md:w-2/3">
                <input class="bg-grey-lighter appearance-none border-2 border-grey-lighter hover:border-purple rounded w-full py-2 px-4 text-grey-darker" type="text" placeholder="example@1m0.de" name="email">
            </div>
        </div>
        <div class="md:flex md:items-center mb-6">
            <div class="md:w-1/3">
            ...
            <div class="md:w-2/3">
                <input class="bg-grey-lighter appearance-none border-2 border-grey-lighter hover:border-purple rounded w-full py-2 px-4 text-grey-darker" type="text" placeholder="Message..." name="data">
            </div>
        </div>
        <div class="md:flex md:items-center mb-6">
